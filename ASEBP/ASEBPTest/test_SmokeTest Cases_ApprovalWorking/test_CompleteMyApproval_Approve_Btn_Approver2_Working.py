...
def test_Complete_my_approval_Approve_button(test_login):
   # Apply Filter for Search Request field in My task section
    try:
       ...
       print("Filters are not applied succesfully in My Task section for approver 2")
    ...
    try:
       ...
       print("Unable to click on Selected Approval Request after applied Filters by approver 2")
   ...
   #Click on Complete My Approval button
    try:
       ...
       print("Unable to click on Complete My Approval button by approver 2")
    ...
    try:
        ...
        time.sleep(2)
        TEXT = " Assessment notes by Approver 2 Request is marked as Approved"
        ...
        print("Unable to add assessment notes by approver 2")
   ...
   #Click on the Add document Link
    try:
        ...
        print("Unable to click on Document link by approver 2")
    ...
    try:
       ...
       # Click on Link Radio button
        ...
        print("Unable to add any one of the field Title,Link & Description under Documents section by Approver 2")
   # Scroll down and click on Final Review button
    ...
    try:
        ...
        print("Unable to mark final review as Approve by approver 2")
   ...
   # Click on Submit Button
    try:
       ...
       # Select yes on confirmation window
        ...
        print("Unable to click on submit button by Approver 2")
