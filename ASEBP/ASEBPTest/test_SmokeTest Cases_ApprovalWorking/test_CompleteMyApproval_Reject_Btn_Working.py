...
def test_Complete_my_approval_Approve_button(test_login):
   ...
   #Click on Complete My Approval button
    ...
    try:
        TEXT = " Assessment notes by Approver 1 Request is rejected"
   ...
   # Scroll down and click on Final Review button
    ...
    # Mark Final review as "Reject"
    try:
        Final_review = driver.find_element_by_xpath("//p[text()='Reject']")
        Final_review.click()
        # time.sleep(2)
    except:
       print("Unable to mark final review as Reject")
